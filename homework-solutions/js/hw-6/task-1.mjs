...
*/
const secondArray = [3, 11, 32, 7, 20];
const [first, second, ...rest] = secondArray;
...
*/
const arrayTomerge = [1, 2, 3, 4, 5];
const arrayTomerge2 = [6, 7, 8, 9, 10];
const mergedArray = [...arrayTomerge, ...arrayTomerge2];
